...
def generate_launch_description():
    world_file_name = 'rosbot_sim_room_12.world'
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('tutorial_pkg', default_value=[EnvironmentVariable('USER'),
            '_'], description='tutorial_pkg_node'
        ),
        Node(package='tutorial_pkg', executable='simulate', output='screen', name=
            [LaunchConfiguration('tutorial_pkg'), 'simulate']
        ),
        gazebo_server,
        gazebo_client,
        spawn_rosbot,
